      ...
      <div className="w-full h-full flex flex-col animate-in fade-in duration-1000 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-4 shrink-0 h-20 border-t border-neutral-900/50">
            <div className="flex items-center space-x-8 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setShowPlayers(true)}>
                ...
                <div className="text-neutral-500 text-sm font-medium">{room.players.length} DJs Online</div>
            </div>
            <div className="flex items-center space-x-6">
                <button onClick={() => setShowPlayers(true)} className="p-3 rounded-full bg-neutral-800 text-neutral-400 hover:text-white hover:bg-neutral-700 transition-colors" title="Manage Players">
                    <User size={20} />
                </button>
                <button onClick={() => setShowSettings(true)} className="p-3 rounded-full bg-neutral-800 text-neutral-400 hover:text-white hover:bg-neutral-700 transition-colors" title="Settings">
                    <Settings size={20} />
                </button>
    ...
    <div className="w-full h-full flex flex-col animate-in fade-in duration-1000 relative overflow-hidden">
      <div className="flex justify-between items-center px-4 py-4 shrink-0 h-20">
        <div className="space-y-0.5">
            ...
            <h1 className="text-3xl font-black max-w-xl truncate leading-none">{activePlayer ? `${activePlayer.nickname}'s Pick` : "Next Up"}</h1>
        </div>
