  ...
  return (
    <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-500 text-center">
      <div className="flex flex-col items-center space-y-4">
        ...
        <h2 className="text-3xl font-bold">{t("queued")}</h2>
        <p className="text-neutral-400">
          {language === "de" ? "Dein Track wurde zur Playlist hinzugefügt. Mach dich bereit für die Party!" : "Your track has been added to the playlist. Get ready to party!"}
        </p>
      </div>
